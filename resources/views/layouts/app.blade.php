...
<script>
    function initFlatpickr() {
        document.querySelectorAll('.datepicker').forEach(function(el){
            if(!el._flatpickr){ // voorkom dubbele initialisatie
                flatpickr(el, {
    ...
    // Eerste keer dat Livewire is geladen
    $(document).ready(function() {

        console.log("Livewire loaded, init Flatpickr");
        initFlatpickr();
    });

    // Elke keer dat Livewire DOM update
    document.addEventListener('livewire:update', function () {

        console.log("Livewire updated, re-init Flatpickr");
        initFlatpickr();
    });
</script>
<script>
