            ...
            <div class="w-full max-w-8xl mx-auto p-6 sm:p-10">
                ...
                <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    <a href="/offertes" class="group relative rounded-2xl bg-white ring-1 ring-black/5 shadow-sm p-8 sm:p-10 flex flex-col items-center gap-5 transition transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-800">
                        ...
                        <span class="text-lg font-semibold tracking-tight text-neutral-900">      {{ __('messages.Offerte tool') }}</span>
                        ...
                        <a href="/orders" class="group relative rounded-2xl bg-white ring-1 ring-black/5 shadow-sm p-8 sm:p-10 flex flex-col items-center gap-5 transition transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-800">
                            ...
                            @admin
                                <!-- Rechsboven icoontje -->
                                @if(count($openOrders))
                                <span class="absolute top-3 right-3 h-[20px] w-[20px] flex items-center justify-center text-[12px] text-white rounded-full border border-orange-500 bg-red-500">
                                    {{ count($openOrders) }}
                                </span>
                                @endif
                            @endadmin
                    ...
                    @endif
                    <!-- Card -->
                    <a href="/detail-maps" class="group relative rounded-2xl bg-white ring-1 ring-black/5 shadow-sm p-8 sm:p-10 flex flex-col items-center gap-5 transition transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-800">
                        ...
                        <span class="text-lg font-semibold tracking-tight text-neutral-900">{{ __('messages.Voorbeeld details') }}</span>
                        <span class="absolute inset-0 rounded-2xl ring-1 ring-transparent group-hover:ring-neutral-200/80"></span>
                    </a>

                    <!-- Card -->
                    <a href="/marketing-maps" class="group relative rounded-2xl bg-white ring-1 ring-black/5 shadow-sm p-8 sm:p-10 flex flex-col items-center gap-5 transition transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-800">
                        <!-- Icon: Chart Bar -->
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" class="h-12 w-12 text-neutral-700">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 19.5h18M6 16.5V9.75M12 16.5V6.75M18 16.5v-5.25"/>
                        </svg>
                        <span class="text-lg font-semibold tracking-tight text-neutral-900">{{ __('messages.Mijn marketing') }}</span>
                        <span class="absolute inset-0 rounded-2xl ring-1 ring-transparent group-hover:ring-neutral-200/80"></span>
                    </a>
                    ...
                    <a href="/documentation-maps" class="group relative rounded-2xl bg-white ring-1 ring-black/5 shadow-sm p-8 sm:p-10 flex flex-col items-center gap-5 transition transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-800">
                        ...
                        <span class="text-lg font-semibold tracking-tight text-neutral-900">{{ __('messages.Documentatie') }}</span>
                        <span class="absolute inset-0 rounded-2xl ring-1 ring-transparent group-hover:ring-neutral-200/80"></span>
                    </a>
                    @if(!\Illuminate\Support\Facades\Auth::user()->is_architect || \Illuminate\Support\Facades\Auth::user()->is_admin)
                        <!-- Card -->
                        <a href="/pricelist" class="group relative rounded-2xl bg-white ring-1 ring-black/5 shadow-sm p-8 sm:p-10 flex flex-col items-center gap-5 transition transform hover:-translate-y-0.5 hover:shadow-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-800">
                            ...
                            <span class="text-lg font-semibold tracking-tight text-neutral-900 text-center">{{ __('messages.Voorwaarden / Prijslijst') }}</span>
                            <span class="absolute inset-0 rounded-2xl ring-1 ring-transparent group-hover:ring-neutral-200/80"></span>
                        </a>
                    @endif
                </section>
