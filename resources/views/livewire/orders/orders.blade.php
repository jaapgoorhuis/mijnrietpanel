            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="relative">
                    ...
                    <div class="relative md:absolute right-0 top-0">
                        ...
                        @endadmin
                        <button wire:click="newOrder()" type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
