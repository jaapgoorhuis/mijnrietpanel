                ...
                <div class="grid">
                    <form>
                        ...
                        <div class="relative z-0 w-full mb-5 group">
                            ...
                            <input type="text"  wire:keydown="filterSubcontractors()" wire:model="bedrijfsnaam" name="bedrijfsnaam" id="bedrijfsnaam" class="block py-2.5 px-0 w-full text-md text-gray-900 border-0 border-b-2 border-gray-300 appearance-none dark:text-gray-900 dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-b-[#C0A16E]" placeholder=" " required />
