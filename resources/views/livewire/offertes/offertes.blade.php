            ...
            <div class="p-6 text-gray-900">
                ...
                <div class="relative mb-[20px]">
                    ...
                    <div class="relative md:absolute right-0 top-0 ">
                        ...
                        <button wire:click="newOfferte()" type="button" class="mt-[10px] text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5  dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                ...
                <div wire:ignore class="overflow-x-auto">
                    <table id="offerte-table" class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
