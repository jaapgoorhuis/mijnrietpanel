<x-slot name="header">
    <nav class="flex">
        <ol class="inline-flex items-center space-x-2">
            <li><a href="/dashboard" class="text-gray-700 hover:text-[#C0A16E]">  {{ __('messages.Mijn Rietpanel') }}</a></li>
            <li><i class="fa-solid fa-angle-right"></i></li>
            <li><a href="/documentation-maps" class="text-gray-700 hover:text-[#C0A16E]">  {{ __('messages.Documentatie categorieën') }}</a></li>
            <li><i class="fa-solid fa-angle-right"></i></li>
            <li><a href="/documentation-maps/{{$folderId}}/documentation" class="text-gray-700 hover:text-[#C0A16E]">{{$folder->name}}</a></li>
            <li><i class="fa-solid fa-angle-right"></i></li>
