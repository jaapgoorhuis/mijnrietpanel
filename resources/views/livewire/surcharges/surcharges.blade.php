    ...
    <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <button wire:click="newSurcharge()" type="button" class="w-full sm:w-auto mt-[10px] text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5">
                    <i class="fa fa-plus hover:cursor-pointer"></i> Toeslag aanmaken
                </button>

                <div class="overflow-x-auto">
                    <table id="surcharges-table" class="custom-datatable w-full text-sm text-left text-gray-500  mt-[25px]">
                                ...
                                <tr class="border-b ">
                                    ...
                                    <td  class="px-4 py-3 flex items-center justify-end">
                                        ...
                                        <div wire:ignore.self id="{{$surcharge->id}}-dropdown" class="hidden z-10 w-auto bg-white rounded divide-y divide-gray-100 shadow block " style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate(1412px, 425px);" data-popper-placement="bottom">
                                            <ul class="py-1 text-sm text-gray-700 " aria-labelledby="{{$surcharge->id}}-dropdown-button">
                                                <li>
                                                    <button
