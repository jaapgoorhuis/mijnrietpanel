    ...
    <table align="center" width="600" style="align:center; text-align:center;  background-color:#e5e7eb; margin:auto; padding:20px;">
        ...
        <tr>
            <td>
                ...
                Er is een nieuw account aangevraagd op my.rietpanel.com met het emailadres: {{$email}}<br/>
                Je kunt het account in https://my.rietpanel.com/accountrequests activeren en aan een bedrijf toe wijzen.<br/>
