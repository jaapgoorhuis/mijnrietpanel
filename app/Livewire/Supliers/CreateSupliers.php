...
class CreateSupliers extends Component
{
    ...
    public $toepassing_dak = 0;
    public $toepassing_wand = 0;
    ...
    public function render()
    {
        if(Auth::user()->is_admin) {
            return view('livewire.supliers.createSupliers');
        } else {
    ...
    {
        return [
            'suplier_name' => 'required|unique:supliers,suplier_name',
    ...
    public function createSuplier() {
        ...
        session()->flash('success','De leverancier is aangemaakt.');
        return $this->redirect('/supliers', navigate: true);
    }

    public function cancelCreateSuplier() {
        return $this->redirect('/supliers', navigate: true);
    }
}
